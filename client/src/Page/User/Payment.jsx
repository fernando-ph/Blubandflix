...
export default function Payment() {
    ...
    const handleBuy = useMutation(async (e) => {
        try {
            ...
            const response = await API.post('/transactions', null, config)
            ...
            if (window.snap) {
                window.snap.pay(token, {
                    ...
                    onError: function (result) {
                        ...
                        // Optionally update status to 'cancel' or 'failed' if the backend supports it
                        // updateTransactionStatus(transactionId, "cancel");
                        navigate("/profile");
                    },
                    onClose: function () {
                        alert("you closed the popup without finishing the payment");
                        // Optionally update status to 'cancel' if the backend supports it
                        // updateTransactionStatus(transactionId, "cancel");
                    },
                });
            } else {
        ...
        <>
            <div style={{backgroundColor:"black", height:"1300px"}}>
                ...
                <div className="mt-5" style={{width:"40%", margin:"auto", color:"white", textAlign:"center"}}>
                    <h2>Premium</h2>
                    Only with one super click you can enjoy the latest movie streaming from bluebandflix
                    <br />
