import React, {useState, useCallback, useEffect} from "react"; // Import useCallback and useEffect
...
export default function DetailTVAdmin() {
    ...
    const seriesadmin = series.find(item => item.id === parseInt(id));
    ...
    return (
        ...
        <div style={{backgroundColor:"black"}}>
                {seriesadmin?.link && <TvPlayer series={seriesadmin} />}
            </div>
                ...
                <Row>
                    <Col>
                        <div>
                            <Row className="ps-5">
                                <Col xs={2}>
                                    <img src={seriesadmin?.image} alt="cover" style={{height:"10%"}} />
                                </Col>
                                <Col>
                                    <div>
                                        <h3>{seriesadmin?.title}</h3>
                                        <i>{seriesadmin?.year}</i><Button variant="outline-light" className="ms-2 mb-2">TV Series</Button>
                                        <p>{seriesadmin?.description} </p>
                                    </div>
                                </Col>
                            </Row>
                        </div>
